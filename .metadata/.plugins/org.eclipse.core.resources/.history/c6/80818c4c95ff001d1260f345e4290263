#ifndef SL_EMLIB_GPIO_INIT_CLC_CONFIG_H
#define SL_EMLIB_GPIO_INIT_CLC_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_CLC_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_CLC_MODE        gpioModeInputPullFilter

// <o SL_EMLIB_GPIO_INIT_CLC_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_CLC_DOUT        1
...
// <gpio> SL_EMLIB_GPIO_INIT_CLC
// $[GPIO_SL_EMLIB_GPIO_INIT_CLC]
#define SL_EMLIB_GPIO_INIT_CLC_PORT              gpioPortF
#define SL_EMLIB_GPIO_INIT_CLC_PIN               7
// [GPIO_SL_EMLIB_GPIO_INIT_CLC]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_CLC_CONFIG_H
