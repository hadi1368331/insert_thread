#ifndef SL_EMLIB_GPIO_INIT_DATA_READY_CONFIG_H
#define SL_EMLIB_GPIO_INIT_DATA_READY_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_DATA_READY_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_DATA_READY_MODE        gpioModeInputPull

// <o SL_EMLIB_GPIO_INIT_DATA_READY_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_DATA_READY_DOUT        1
...
// <gpio> SL_EMLIB_GPIO_INIT_DATA_READY
// $[GPIO_SL_EMLIB_GPIO_INIT_DATA_READY]
#define SL_EMLIB_GPIO_INIT_DATA_READY_PORT       gpioPortC
#define SL_EMLIB_GPIO_INIT_DATA_READY_PIN        9
// [GPIO_SL_EMLIB_GPIO_INIT_DATA_READY]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_DATA_READY_CONFIG_H
