...
// -------------------------------
/**
 *  Context-Callback declaration (WEAK functions). Functions should be overwritten to reach full functionality.
 */
 ...
 */
/**
 * 'DynoDesk_Matter' service.
 */
extern const HAPService DynoDesk_Matter;
/**
