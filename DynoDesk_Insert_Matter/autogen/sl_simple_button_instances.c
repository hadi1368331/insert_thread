...
#include "sl_simple_button_UART_Data_config.h"
...
sl_simple_button_context_t simple_uart_data_context = {
  .state = 0,
  .history = 0,
  .port = SL_SIMPLE_BUTTON_UART_DATA_PORT,
  .pin = SL_SIMPLE_BUTTON_UART_DATA_PIN,
  .mode = SL_SIMPLE_BUTTON_UART_DATA_MODE,
};

const sl_button_t sl_button_uart_data = {
  .context = &simple_uart_data_context,
  .init = sl_simple_button_init,
  .get_state = sl_simple_button_get_state,
  .poll = sl_simple_button_poll_step,
  .enable = sl_simple_button_enable,
...
{
  sl_button_init(&sl_button_uart_data);
...
{
  sl_button_poll_step(&sl_button_uart_data);
