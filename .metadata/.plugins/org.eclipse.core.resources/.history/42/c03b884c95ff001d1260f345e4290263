#ifndef SL_EMLIB_GPIO_INIT_READ_DATA_CONFIG_H
#define SL_EMLIB_GPIO_INIT_READ_DATA_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_READ_DATA_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_READ_DATA_MODE        gpioModePushPull

// <o SL_EMLIB_GPIO_INIT_READ_DATA_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_READ_DATA_DOUT        1
...
// <gpio> SL_EMLIB_GPIO_INIT_READ_DATA
// $[GPIO_SL_EMLIB_GPIO_INIT_READ_DATA]
#define SL_EMLIB_GPIO_INIT_READ_DATA_PORT        gpioPortC
#define SL_EMLIB_GPIO_INIT_READ_DATA_PIN         11
// [GPIO_SL_EMLIB_GPIO_INIT_READ_DATA]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_READ_DATA_CONFIG_H
