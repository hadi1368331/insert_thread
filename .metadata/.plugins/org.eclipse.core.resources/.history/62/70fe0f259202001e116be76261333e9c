...
#include "sl_simple_button_DataReady_in_from_Xmega_config.h"
...
sl_simple_button_context_t simple_dataready_in_from_xmega_context = {
  .state = 0,
  .history = 0,
  .port = SL_SIMPLE_BUTTON_DATAREADY_IN_FROM_XMEGA_PORT,
  .pin = SL_SIMPLE_BUTTON_DATAREADY_IN_FROM_XMEGA_PIN,
  .mode = SL_SIMPLE_BUTTON_DATAREADY_IN_FROM_XMEGA_MODE,
};

const sl_button_t sl_button_dataready_in_from_xmega = {
  .context = &simple_dataready_in_from_xmega_context,
  .init = sl_simple_button_init,
  .get_state = sl_simple_button_get_state,
  .poll = sl_simple_button_poll_step,
  .enable = sl_simple_button_enable,
...
const sl_button_t *sl_simple_button_array[] = {
  &sl_button_btn0, 
  &sl_button_btn1, 
  &sl_button_dataready_in_from_xmega
};
const uint8_t simple_button_count = 3;

void sl_simple_button_init_instances(void)
{
  sl_button_init(&sl_button_dataready_in_from_xmega);
...
{
  sl_button_poll_step(&sl_button_dataready_in_from_xmega);
