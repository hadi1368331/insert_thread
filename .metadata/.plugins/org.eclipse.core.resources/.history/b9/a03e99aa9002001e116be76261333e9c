...
#include "sl_uartdrv_usart_Xmega_USART_config.h"
#include "sl_uartdrv_usart_vcom_config.h"

UARTDRV_HandleData_t sl_uartdrv_usart_Xmega_USART_handle_data;
UARTDRV_Handle_t sl_uartdrv_usart_Xmega_USART_handle = &sl_uartdrv_usart_Xmega_USART_handle_data;
...
#ifndef SL_UARTDRV_USART_XMEGA_USART_CTS_PORT
#define SL_UARTDRV_USART_XMEGA_USART_CTS_PORT  gpioPortA
#define SL_UARTDRV_USART_XMEGA_USART_CTS_PIN   0
#if defined(_USART_ROUTELOC1_MASK)
#define SL_UARTDRV_USART_XMEGA_USART_CTS_LOC   0
#endif
#endif

#ifndef SL_UARTDRV_USART_XMEGA_USART_RTS_PORT
#define SL_UARTDRV_USART_XMEGA_USART_RTS_PORT  gpioPortA
#define SL_UARTDRV_USART_XMEGA_USART_RTS_PIN   0
#if defined(_USART_ROUTELOC1_MASK)
#define SL_UARTDRV_USART_XMEGA_USART_RTS_LOC   0
#endif
#endif
...
DEFINE_BUF_QUEUE(SL_UARTDRV_USART_XMEGA_USART_RX_BUFFER_SIZE, sl_uartdrv_usart_Xmega_USART_rx_buffer);
DEFINE_BUF_QUEUE(SL_UARTDRV_USART_XMEGA_USART_TX_BUFFER_SIZE, sl_uartdrv_usart_Xmega_USART_tx_buffer);
...
UARTDRV_InitUart_t sl_uartdrv_usart_init_Xmega_USART = { 
  .port = SL_UARTDRV_USART_XMEGA_USART_PERIPHERAL,
  .baudRate = SL_UARTDRV_USART_XMEGA_USART_BAUDRATE,
#if defined(_USART_ROUTELOC0_MASK)
  .portLocationTx = SL_UARTDRV_USART_XMEGA_USART_TX_LOC,
  .portLocationRx = SL_UARTDRV_USART_XMEGA_USART_RX_LOC,
#elif defined(_USART_ROUTE_MASK)
  .portLocation = SL_UARTDRV_USART_XMEGA_USART_ROUTE_LOC,
#elif defined(_GPIO_USART_ROUTEEN_MASK)
  .txPort = SL_UARTDRV_USART_XMEGA_USART_TX_PORT,
  .rxPort = SL_UARTDRV_USART_XMEGA_USART_RX_PORT,
  .txPin = SL_UARTDRV_USART_XMEGA_USART_TX_PIN,
  .rxPin = SL_UARTDRV_USART_XMEGA_USART_RX_PIN,
  .uartNum = SL_UARTDRV_USART_XMEGA_USART_PERIPHERAL_NO,
#endif
  .stopBits = SL_UARTDRV_USART_XMEGA_USART_STOP_BITS,
  .parity = SL_UARTDRV_USART_XMEGA_USART_PARITY,
  .oversampling = SL_UARTDRV_USART_XMEGA_USART_OVERSAMPLING,
#if defined(USART_CTRL_MVDIS)
  .mvdis = SL_UARTDRV_USART_XMEGA_USART_MVDIS,
#endif
  .fcType = SL_UARTDRV_USART_XMEGA_USART_FLOW_CONTROL_TYPE,
  .ctsPort = SL_UARTDRV_USART_XMEGA_USART_CTS_PORT,
  .rtsPort = SL_UARTDRV_USART_XMEGA_USART_RTS_PORT,
  .ctsPin = SL_UARTDRV_USART_XMEGA_USART_CTS_PIN,
  .rtsPin = SL_UARTDRV_USART_XMEGA_USART_RTS_PIN,
  .rxQueue = (UARTDRV_Buffer_FifoQueue_t *)&sl_uartdrv_usart_Xmega_USART_rx_buffer,
  .txQueue = (UARTDRV_Buffer_FifoQueue_t *)&sl_uartdrv_usart_Xmega_USART_tx_buffer,
#if defined(_USART_ROUTELOC1_MASK)
  .portLocationCts = SL_UARTDRV_USART_XMEGA_USART_CTS_LOC,
  .portLocationRts = SL_UARTDRV_USART_XMEGA_USART_RTS_LOC,
#endif
};
...
void sl_uartdrv_init_instances(void){
  UARTDRV_InitUart(sl_uartdrv_usart_Xmega_USART_handle, &sl_uartdrv_usart_init_Xmega_USART);
  sl_uartdrv_set_default(sl_uartdrv_usart_Xmega_USART_handle);
